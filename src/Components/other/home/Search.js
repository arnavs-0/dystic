        ...
        <div className='container-search'>
            <Container fluid>
                <Row>
                    ...
                    <span
                        aria-label={
                            'Find your <br/> next opportunity <br/> today.'
                        }
                        aria-required='true'
                        className='search-form-title text-left'
                    >
                      Find your <br/> next opportunity <br/> today.
                    </span>
                        </Row>
                      ...
                      <span
                          aria-label={
                              'Find Jobs According to your needs simply <br/> click on search and choose jobs based on <br/> your interests'
                          }
                          className='search-form-text text-left'
                      >
                        Find Jobs According to your needs simply <br/> click on
                        search and choose jobs based on <br/> your interests
                      </span>
                            </Col>
                            <Col md='auto'>
                                <div className='wrap-build text-center'>
                        <span
                            aria-label={'or build your resume'}
                            aria-required='true'
                            className='search-form-text text-center'
                        >
                                ...
                                <Form className='search-form'>
                                    <Row>
                                        <Col>
                                            <InputText
                                                reference={jobInput}
                                                wrapper='wrap-input-search'
                                                inputClass='input shadow-none'
                                                name='job'
                                                input='Job Title'
                                                focus='focus-input'
                                            />
                                        ...
                                        <Col>
                                            <div
                                                className='container-search-form-btn'
                                                style={{zIndex: '5', position: 'relative'}}
                                            >
                                                {/*<Link to={"/results"}>*/}
                                                <Button
                                                    className='search-form-btn shadow-none'
                    ...
                    <Col md={'auto'} className='mt-5'>
                        <Image
                            alt='clay type illustration of 5 people of different ethnicity and age.'
                            src={img}
                            fluid
                        />
                    </Col>
